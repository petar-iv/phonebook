...
public class DbConnection {
	...
	private static final String DB_URL = String.format("jdbc:postgresql://%s:%d/%s", HOST, PORT, DB_NAME);
	...
	private static EntityManagerFactory buildFactory() {
		...
		return Persistence.createEntityManagerFactory("phonebook", properties);
	}
